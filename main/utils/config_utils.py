...
from main.config_schemas import config_schema
from main.utils.io_utils import open_file, write_yaml_file
...
def save_config_as_yaml(config: Union["Config", DictConfig], save_path: str) -> None:
    ...
    text_io.writelines(
        [
            ...
            "# If you want to modify configuration, edit source files in main/configs directory.\n",
            "\n",
        ]
    )
...
def load_config_header() -> str:
    config_header_path = Path("./main/configs/automatically_generated/full_config_header.yaml")
...
def setup_logger() -> None:
    with open("./main/configs/hydra/job_logging/custom.yaml", "r") as stream:
