...
from main.config_schemas.infrastructure.instance_group_creator_schemas import InstanceGroupCreatorConfig
...
class MLFlowConfig:
    ...
    experiment_name: str = "parts-prediction-experiment"
