...
from main.infrastructure.instance_template_creator import VMType


@dataclass
class BootDiskConfig:
    project_id: str = "ubuntu-os-cloud"
    name: str = "ubuntu-2204-jammy-v20240126"
    size_gb: int = 50
...
class InstanceTemplateCreatorConfig:
    _target_: str = "main.infrastructure.instance_template_creator.InstanceTemplateCreator"
    ...
    labels: dict[str, str] = field(default_factory=lambda: {"project": "parts-prediction"})
