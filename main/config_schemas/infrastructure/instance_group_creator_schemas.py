...
from main.config_schemas.infrastructure.instance_template_creator_schemas import InstanceTemplateCreatorConfig


@dataclass
class InstanceGroupCreatorConfig:
    _target_: str = "main.infrastructure.instance_group_creator.InstanceGroupCreator"
