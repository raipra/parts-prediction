...
from main.utils.config_utils import get_config_and_dict_config, save_config_as_yaml
from main.utils.mlflow_utils import activate_mlflow, log_artifacts_for_reproducibility, log_training_hparams
...
def generate_final_config(config: "Config", dict_config: DictConfig) -> None:
    ...
    with activate_mlflow(
        ...
        config_save_dir = Path("./main/configs/automatically_generated/")
